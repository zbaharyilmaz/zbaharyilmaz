...
| 🎬  | **[sass-dune-movie-website](https://github.com/zbaharyilmaz/sass-dune-movie-website)**       | Dune Movie Website - In this project, we will create a responsive website using HTML5, CSS3, and Sass/SCSS to clone the Dune novels website. The project utilizes Sass's nesting capabilities and partials to achieve a more streamlined and well-structured codebase.                                                                                                                                               |
