...
Developer with hands-on experience, focusing primarily on frontend development while also contributing to backend systems. Skilled in React.js, Next.js, JavaScript, TypeScript, Node.js, Express.js, Prisma, MongoDB and modern UI frameworks such as Tailwind CSS and Material UI. Dedicated to writing clean, efficient, and maintainable code, collaborating in Agile teams, and delivering solutions that enhance performance and usability.
...
<img src="https://img.shields.io/badge/SQL-003B57?logo=database&logoColor=white&style=flat-square" height="28" alt="SQL" />
<img src="https://img.shields.io/badge/Clerk-6C47FF?logo=clerk&logoColor=white&style=flat-square" height="28" alt="Clerk" />
...
| --- | :------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🤝  | <span style="vertical-align: top;">**[kind-hands](https://github.com/codEdu-Collective/kind-hands)**</span>                            | A platform that connects donors and volunteers with important causes, making donations simple and effective. This project is built with **TypeScript and Next.js**. <br><br><img src="./projects/kind-hands.gif" alt="Kind Hands Demo" width="300" style="display: block; margin: 0 auto;" />                                                                                                                                                                                                                                                               |
